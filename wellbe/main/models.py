...
class MainCategory(models.Model):
    id = models.BigAutoField(primary_key=True)
    category = models.ForeignKey('MainProduct', models.DO_NOTHING, blank=True, null=True)
...
class Product(models.Model):
    ...
    stock_status = models.IntegerField(blank=True, null=True)
    size = models.FloatField(blank=True, null=True)
    size_type = models.CharField(max_length=20, blank=True, null=True)
